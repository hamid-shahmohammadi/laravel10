function listPost() {
    return {
        ...
        editPost(post) {
            ...
            <svg @click="editFormPost(post)" class="ml-2 w-6 text-blue-600" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
