<button class="my-2 bg-blue-800 text-white rounded-md py-2 px-2" @click="showCreateForm=!showCreateForm">Create Post</button>
<hr class="my-4"/>
<div x-cloak x-show="showCreateForm" x-transition.duration.500ms style="background-color:rgba(0,0,0,.5)"
    ...
    <div class="top-20 mx-auto p-5 border w-2/3 shadow-lg rounded-md bg-white">
        ...
        <form @submit.prevent="createPost()" class="py-4">
